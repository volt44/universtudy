...
class RouterListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(
            array(80, 443, 'http://127.0.0.1/', 80, 443),
            array(80, 443, 'http://127.0.0.1:90/', 90, 443),
            array(80, 443, 'https://127.0.0.1/', 80, 443),
            array(80, 443, 'https://127.0.0.1:90/', 80, 90),
        );
    }
    ...
    {
        $kernel = $this->getMock('Symfony\Component\HttpKernel\HttpKernelInterface');
        $request = Request::create('http://127.0.0.1/', 'post');
        $event = new GetResponseEvent($kernel, $request, HttpKernelInterface::MASTER_REQUEST);
        ...
        $kernel = $this->getMock('Symfony\Component\HttpKernel\HttpKernelInterface');
        $request = Request::create('http://127.0.0.1/', 'get');
