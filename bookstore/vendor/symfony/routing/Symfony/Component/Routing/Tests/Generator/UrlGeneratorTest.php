...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        ...
        $this->assertEquals('http://127.0.0.1/app.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithPort443()
    {
        ...
        $this->assertEquals('https://127.0.0.1/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('http://127.0.0.1:8080/app.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('https://127.0.0.1:8080/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('http://127.0.0.1/app.php/testing?foo=bar', $url);
    }
    ...
    {
        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'https'))); // BC
        $this->assertEquals('https://127.0.0.1/app.php/', $this->getGenerator($routes)->generate('test'));

        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'http'))); // BC
        $this->assertEquals('http://127.0.0.1/app.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    ...
    public function testSchemeRequirementCreatesUrlForFirstRequiredScheme()
    {
        ...
        $this->assertEquals('ftp://127.0.0.1/app.php/', $this->getGenerator($routes)->generate('test'));
    }
