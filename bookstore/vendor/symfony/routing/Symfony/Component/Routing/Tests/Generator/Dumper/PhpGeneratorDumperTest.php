...
class PhpGeneratorDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $this->assertEquals($absoluteUrlWithParameter, 'http://127.0.0.1/app.php/testing/bar');
        $this->assertEquals($absoluteUrlWithoutParameter, 'http://127.0.0.1/app.php/testing2');
    ...
    public function testDumpWithSchemeRequirement()
    {
        ...
        $this->assertEquals($absoluteUrl, 'ftp://127.0.0.1/app.php/testing');
        $this->assertEquals($absoluteUrlBC, 'https://127.0.0.1/app.php/testing_bc');
        $this->assertEquals($relativeUrl, 'ftp://127.0.0.1/app.php/testing');
        $this->assertEquals($relativeUrlBC, 'https://127.0.0.1/app.php/testing_bc');

        $projectUrlGenerator = new \SchemeUrlGenerator(new RequestContext('/app.php', 'GET', '127.0.0.1', 'https'));
        ...
        $this->assertEquals($absoluteUrl, 'https://127.0.0.1/app.php/testing');
        $this->assertEquals($absoluteUrlBC, 'https://127.0.0.1/app.php/testing_bc');
