...
class UrlGeneratorServiceProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAbsoluteUrlGeneration()
    {
        ...
        $request = Request::create('https://127.0.0.1:81/');
        $response = $app->handle($request);

        $this->assertEquals('https://127.0.0.1:81/hello/john', $response->getContent());
    }
    ...
    public function testUrlGenerationWithHttp()
    {
        ...
        $this->assertEquals('http://127.0.0.1/insecure', $response->getContent());
    }
    ...
    public function testUrlGenerationWithHttps()
    {
        ...
        $this->assertEquals('https://127.0.0.1/secure', $response->getContent());
    }
}
